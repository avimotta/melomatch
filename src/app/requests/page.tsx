                ...
                >
                  ...
                  <div className="flex shrink-0 items-center gap-2">
                    <button
                      ...
                      className="rounded-full bg-accent px-4 py-1.5 text-xs font-semibold text-background transition-all hover:bg-accent-hover disabled:opacity-50"
                    >
                    ...
                    <button
                      ...
                      className="rounded-full border border-border px-4 py-1.5 text-xs text-foreground transition-colors hover:border-danger/50 hover:text-danger disabled:opacity-50"
                    >
